...
const cardsContiner = document.getElementById('cards')
const showCards = () => {
    ...
    data.forEach(data=>{
        ...
        div.innerHTML = `
                <figure><img src="${data.imageURL}" alt="Shoes" /></figure>
                <div class="card-body">
                  <h2 class="card-title">
                    name: ${data.name}
                  </h2>
                ...
                <button class="btn block mx-auto my-10">buy</button>
       `
       cardsContiner.appendChild(div)
    })
}
